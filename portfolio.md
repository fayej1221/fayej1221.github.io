...
---
## 📖  교육 | Edcation
- **국립공주대학교** 2020.03 - 2025.08.(수료 상태, 졸업 예정)
    - 주전공: 컴퓨터공학부 컴퓨터공학전공
    - 부전공: 응용수학과
...
자율주행 분야에 대한 **흥미와 의지**가 낮았으나, 이번 프로젝트를 통해 흥미가 생겼고, **Depth Estimation**에 대한 관심도 커졌습니다. **Metric Depth 모델**은 특정 데이터셋에서는 잘 작동했지만, **직접 찍은 데이터**에는 적용되지 않았습니다. 만약 시간이 더 있었다면 **파인튜닝**을 시도해보았을 것 같다는 아쉬움이 남습니다. 또한, **ONNX**를 적용해보기도 했습니다.
...
프로젝트 진행 기간: 2022.05. - 2022.08. (4개월)
